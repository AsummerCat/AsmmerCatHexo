...
```
-----------------------------------------
oneByOneLoop开始1539613451474
oneByOneLoop循环的次数:1000000000
oneByOneLoo返回值:-1243309312
oneByOneLoop结束1539613452130
oneByOneLoop运行时长656毫秒
-----------------------------------------
oneTimeLoop开始1539613452131
oneTimeLoop循环的次数:1
oneTimeLoop返回值:904174336
oneTimeLoop结束1539613452131
oneByOneLoop运行时长0毫秒
-----------------------------------------
结论第二种算法比第一种快  也就是说好的算法 可以大大优化你的运算速度
```